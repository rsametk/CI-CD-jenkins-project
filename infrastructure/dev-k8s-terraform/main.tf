...
resource "aws_iam_instance_profile" "petclinic-master-server-profile-01" {
  name = "petclinic-master-server-profile-01"
...
resource "aws_instance" "kube-master" {
    ...
    iam_instance_profile = aws_iam_instance_profile.petclinic-master-server-profile-01.name
